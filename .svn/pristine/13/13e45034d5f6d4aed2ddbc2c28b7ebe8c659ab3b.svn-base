...
import com.inveno.cps.authenticate.thrift.AuthenticateService.Client;
import com.inveno.cps.authority.model.User;
import com.inveno.cps.common.baseclass.IBaseDAO;
import com.inveno.cps.common.exception.BusinessException;
import com.inveno.cps.thrift.ClientPool;
...
/*	public static FirmAccount getFirmAccount(){
	...
	public static User getUser() {
		...
		AuthenticateService.Client client   = (Client) ClientPool.getClient("AuthenticateService");
		Map<String, String> map = new HashMap<String,String>();
		try {
			map = client.getUserInfo(uuid);
		} catch (TException e) {
			e.printStackTrace();
			return user;
		} catch (Exception e) {
			...
			ClientPool.recoverClient("AuthenticateService", client);
		}
